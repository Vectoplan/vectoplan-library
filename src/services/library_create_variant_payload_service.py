...
JSON_KEY_ALIASES: Final[Mapping[str, str]] = {
    ...
    "spatial_contract_json": "spatial_contract",
    "spatialContractJson": "spatial_contract",
    "connection_points_json": "connection_points",
    "connectionPointsJson": "connection_points",
