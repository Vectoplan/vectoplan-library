/* services/vectoplan-library/static/library_admin/js/create_variant_utils.js */

/* -----------------------------------------------------------------------------
 * VECTOPLAN Library · Create Wizard · Variant Utils
 *
 * Zweck:
  ...
  function normalizeDefinitions(raw) {
    try {
      ...
      return {
        ...
        materials: toArrayOrObjectValues(defs.materials),
