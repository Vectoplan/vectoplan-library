/* services/vectoplan-library/static/js/vplib/create/create_preview.js */
(function () {
  "use strict";

  var GLOBAL_NAME = "VectoplanCreatePreview";
  var MODULE_NAME = "preview";
  var PREVIEW_VERSION = "0.7.0";
  ...
  function updateVisualPreview(form, placeholder, data) {
    try {
      ...
      if (safeData.animate && placeholder) {
    ...
    try {
      ...
      workspaceNodes.concat(drawerNodes).forEach(function (node) {
        try {
          ...
          node.setAttribute("data-vp-current-taxonomy-path", context.taxonomy_path);
  ...
  function getContext(form) {
    try {
      var safeForm = resolveForm(form);
      var coreState = core && core.state ? core.state : {};
      var defaults = getNested(coreState.uiState, ["defaults"], {});
      ...
      return {
        ...
        taxonomy_path: [domain, category, subcategory].join("/"),
        taxonomyPath: [domain, category, subcategory].join("/"),
